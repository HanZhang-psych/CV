...
Attention; Cognitive Control; Distraction; Human-AI Systems
...
## As Assistant Research Scientist
...
```{r}
bibliography_entries("bibs/talks.bib")
```
...
tribble(
  ...
  "Mentored undergraduate students conducting research projects.",
) %>%
  detailed_entries(where = Year,
                   with = Name,
                   what = Duty) 
...
tribble(
  ...
  ~ Duty,
  '2018 - 2020',
  "Mentored students: Brianna Westpfahl (2019), Michael Cloud (2019), Julliana Ramirez-Matias (2019), Rachel Kushner (2020), Ruby Zheng (2020), Skylar Brodnan (2020)",
  "Mentored underrepresented students on academic research engagement and transferable skills. More info: https://lsa.umich.edu/psych/undergraduates/star-scholars-program.html",
) %>%
  detailed_entries(where = Year,
                   with = Name,
                   what = Duty) 
...
-   [PupEyes: An Interactive Python Library for Eye Movement Data Processing](https://pupeyes.readthedocs.io/)
...
tribble(
  ...
  ~ Outcome,
  '2026',
  'Toward Human-Inspired Cognitive Architectures for Robust Autonomous Driving',
...
-   IEEE Intelligent Transportation Systems Transaction
-   Autism
